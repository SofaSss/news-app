...
abstract class $NewsModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int id, String title, String image_url, String url, String summary});
}
...
class _$NewsModelImpl implements _NewsModel {
  ...
  @override
  String toString() {
    return 'NewsModel(id: $id, title: $title, image_url: $image_url, url: $url, summary: $summary)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, image_url, url, summary);
...
abstract class _NewsModel implements NewsModel {
  const factory _NewsModel(
      ...
      required final String summary}) = _$NewsModelImpl;
